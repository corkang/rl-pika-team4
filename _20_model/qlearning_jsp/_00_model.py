...
from _20_model import qlearning_jsp
...
class Qlearning:
    def __init__(self, conf, policy_name_for_play=None):
        ...
        if self.conf.train_rewrite is not True:
            try:
                self.policy = qlearning_jsp._02_qtable.load_qtable(
                    self.policy_path)
            except:
                self.policy = qlearning_jsp._02_qtable.create_qtable()
        else:
            self.policy = qlearning_jsp._02_qtable.create_qtable()
    ...
    def get_transition(self, env, state_mat):
        ...
        action_mat = qlearning_jsp._06_algorithm.\
    ...
    def update(self, transition):
        ...
        td_target = qlearning_jsp._06_algorithm.calculate_qtarget(
            policy=self.policy,
            reward=reward_next,
    ...
    def get_train_configuration(self):
        train_conf = qlearning_jsp._01_params.get_train_params()
        return train_conf
    ...
    def update_epsilon(self):
        ...
        self.epsilon = qlearning_jsp._06_algorithm.\
    ...
    def map_to_designed_state(self, state_mat):
        ...
        ===================================================================================================="""
        state_custom = qlearning_jsp._03_state_design.calculate_state_key(
            state_mat)
    ...
    def map_to_designed_action(self, action_mat):
        ...
        action_custom = action_mat *\
            qlearning_jsp._04_action_space_design.action_mask()
    ...
    def map_to_designed_reward(self, reward_mat):
        ...
        reward_custom = qlearning_jsp._05_reward_design.calculate_reward(
            reward_mat)
    ...
    def save(self):
        ...
        ================================================================================================"""
        qlearning_jsp._02_qtable.save_qtable(self.policy, self.policy_path)
