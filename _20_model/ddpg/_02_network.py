...
class CriticNetwork(nn.Module):
    ...
    def forward(self, state, action):
        ...
        return self.layers(critic_input)
...
def create_critic_nn(dim_state, dim_action, hidden_dim, hidden_layer_count):
    return CriticNetwork(dim_state, dim_action, hidden_dim, hidden_layer_count)
